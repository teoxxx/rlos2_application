...
;************************************************************************************************************************************************************************************************
;************************************************************************************************************************************************************************************************
DATAPATH='Q:\gitstuff\PAPER8_21dummies\'
cd, datapath
...
if (pload_float_factor eq 1.0) then pload, 3,shrink =sfactor_external, dir=datapath,/float else pload, 1,shrink =sfactor_external, dir=datapath,/double
...
DATAPATH='Q:\gitstuff\torblobgoodhope'
cd, datapath
GDL_DIR='C:\Program Files (x86)\gnudatalanguage\gdlde'
PATH=!PATH+'C:\Program Files (x86)\gnudatalanguage\gdlde\'
