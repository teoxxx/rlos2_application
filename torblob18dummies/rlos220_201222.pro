...
DATAPATH='E:\applications\scrange\torblob18dummies\'
cd, datapath
...
if (debug_comments_fun eq 1) then print,'1a2b,aaaa_back_in_time_tpicked=where((   (curtime_fun +t_fun)  -   (tpicked_fun-t_fun))<0,count_tpicked_fun)'
