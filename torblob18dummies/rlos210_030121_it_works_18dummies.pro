...
;************************************************************************************************************************************************************************************************
maxdummy=15.0
DATAPATH='D:\archivedwl-126\data_results_nemiss_output\med_res\phi1_sixty_degrees_phi2_zero_img_geom_case_2_two\torblob18dummies\'
cd, datapath
GDL_DIR='C:\Program Files (x86)\gnudatalanguage\gdlde'
PATH=!PATH+'C:\Program Files (x86)\gnudatalanguage\gdlde\'
!PATH=!PATH+datapath
file_early =DATAPATH+'rlos_params_v246.txt'
CLOSE, 18
 OPENR, 18, file_early
...
pro global_absorption,Temp_4d,PRS_4d,RHO_4d,dopplerfactordivisor,xfrac,gaunt,ng,emiss,resultvectorfinal,kabs_4d,kabs2_4d,NLONG
...
pro global_calculations,phi1_fun,phi2_fun,vx1_4d,vx2_4d,vx3_4d,v_4d,speedtweakfactor,coslosu_4d,lx1,lx2,lx3,thetau_4d,gammalorentz_4d,ccccc,ncalc,ng,dopplerfactor_4d,debug_comments_fun,focused_beam_switch_fun
...
;190819 cos of the angle between LOA and local velocity, is outsourced to another procedure. SOS check that lx1,lx2,lx3 are dependent on focal point, for cam obsc case! SOS CHECK IT!!!
...
pro emiss_global_calc, dopplerchoice,emiss_4d,rho_4d,dopplerfactor_4d,alphaindex,freqfactor,spectrum_direct_switch,jet_spectrum_built_in_function_test_unity_at_108,debug_spectra_switch,emiss_4d_implied,emiss_4d_direct,dummy2_4d_fun,dummy3_4d_fun,pion_emissivity_switch,neutrino_emissivity_switch
...
aaaa_back_in_time_tpicked=where((   (curtime_fun +t_fun)  -   (tpicked_fun-t_fun))<0,count_tpicked_fun)
...
shotnumber_fun= shotnumber_tpicked_fun-count_tpicked_fun-shotmin_fun
...
taun_fun=double(taun_fun)+double(dtaun(counter))
tauncurrent(counter)=double(taun_fun)
if (debug_comments_fun eq 1) then print, 'EDO TO IN', in_fun, din(counter), taun_fun
...
global_calculations,phi1,phi2,vx1_4d,vx2_4d,vx3_4d,v_4d,speedtweakfactor,coslosu_4d,lx1,lx2,lx3,thetau_4d,gammalorentz_4d,ccccc,ncalc,ng,dopplerfactor_4d,debug_comments,focused_beam_switch
...
;210819 Indeed!
emiss_global_calc, dopplerchoice,emiss_4d,rho_4d,dopplerfactor_4d,alphaindex,freqfactor,spectrum_direct_switch,jet_spectrum_built_in_function_test_unity_at_108,debug_spectra_switch,emiss_4d_implied,emiss_4d_direct,dummy2_4d,dummy3_4d,pion_emissivity_switch,neutrino_emissivity_switch
...
global_absorption,Temp_4d,PRS_4d,RHO_4d,dopplerfactordivisor,xfrac,gaunt,ng,emiss,resultvectorfinal,kabs_4d,kabs2_4d,NLONG
...
shade_surf, ((counterlast)), ax=35, az=-110, /zlog, xstyle=2, MAX_VALUE=1000, MIN_VALUE=1, xstyle=2,$
ystyle=2, zstyle=2, xtitle='X', ytitle='Y', ztitle='Z', xticklayout=0, background=255, color=0, xthick=2, $
ythick=2, zthick=2, xcharsize=3, ycharsize=3, zcharsize=3
stop
...
;**********;***********************************************************
;*******************************************
;010121 SOS command thT PRINTS ALL BUT DUMMY 10 WHICH WAS OVERWRITTEN BY HURAAAHHH DATA, ALIGNMENT SELF CHECK DATA!
...
;verified 217.97647  6.9022056e+010       490718.76  1.8811388e+012  5.3051595e+009       25942591.       180875.33       1610.1605      0.68413232  2.7487977e+010     0.032037638  9.2708121e-006
  ;2.0927995e-006  5.9249124e-008  2.7080211e-010      0.00000000
stop
