;This program is released under the LGPL-3.0-or-later licence, Copyright 2016,2018 Theodoros Smponias. It is based on a routine provided by Andrea Mignone, with the PLUTO astrophysical code. 
;
...
;SOS AN ALSO idl begis arrays at 0, mathem at 1! Else, they match element value to element value. SOS!
; ----------------------------------------------------------------------
...
PRO MATCH_VARNAME, vpt, name, silent=silent
 ...
 CASE name OF
   ...
   "psi_glm": BEGIN psi_glm = vpt & match = 1 & END
    "dummy1":  BEGIN dummy1  = vpt & match = 1 & END
    "dummy2":  BEGIN dummy2  = vpt & match = 1 & END
        "dummy3":  BEGIN dummy3  = vpt & match = 1 & END
         "dummy4":  BEGIN dummy4  = vpt & match = 1 & END
          "dummy5":  BEGIN dummy5  = vpt & match = 1 & END
          "dummy6":  BEGIN dummy6  = vpt & match = 1 & END
          "dummy7":  BEGIN dummy7  = vpt & match = 1 & END
          "dummy8":  BEGIN dummy8  = vpt & match = 1 & END
          "dummy9":  BEGIN dummy9  = vpt & match = 1 & END
          "dummy10":  BEGIN dummy10  = vpt & match = 1 & END
          "dummy11":  BEGIN dummy11  = vpt & match = 1 & END
          "dummy12":  BEGIN dummy12 = vpt & match = 1 & END
                "dummy13":  BEGIN dummy13  = vpt & match = 1 & END
          "dummy14":  BEGIN dummy14  = vpt & match = 1 & END
          "dummy15":  BEGIN dummy15 = vpt & match = 1 & END
                   "dummy16":  BEGIN dummy16  = vpt & match = 1 & END
          "dummy17":  BEGIN dummy17  = vpt & match = 1 & END
          "dummy18":  BEGIN dummy18 = vpt & match = 1 & END
