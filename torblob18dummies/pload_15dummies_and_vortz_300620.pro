   ...
   "psi_glm": BEGIN psi_glm = vpt & match = 1 & END
    ...
    "dummy2":  BEGIN dummy2  = vpt & match = 1 & END
        "dummy3":  BEGIN dummy3  = vpt & match = 1 & END
         "dummy4":  BEGIN dummy1  = vpt & match = 1 & END
          "dummy5":  BEGIN dummy2  = vpt & match = 1 & END
          "dummy6":  BEGIN dummy3  = vpt & match = 1 & END
          "dummy7":  BEGIN dummy1  = vpt & match = 1 & END
          "dummy8":  BEGIN dummy2  = vpt & match = 1 & END
          "dummy9":  BEGIN dummy3  = vpt & match = 1 & END
          "dummy10":  BEGIN dummy1  = vpt & match = 1 & END
          "dummy11":  BEGIN dummy2  = vpt & match = 1 & END
          "dummy12":  BEGIN dummy3  = vpt & match = 1 & END
